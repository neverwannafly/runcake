...
const NewIAMCredentialPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await iamCredentialsAPI.create({
      ...
      if (response.success) {
        ...
        setErrors({ submit: response.message || 'Failed to create IAM credential' })
      }
    } catch (error) {
      console.error('Error creating IAM credential:', error)
      setErrors({ submit: error.message || 'Failed to create IAM credential. Please try again.' })
    } finally {
      ...
      <div className="flex items-center space-x-4">
        ...
        <div>
          <h1 className="text-3xl font-bold bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent">
            Add New IAM Credential
          </h1>
          <p className="text-gray-600 mt-1">
            Add AWS access credentials for script execution
          </p>
        </div>
      </div>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div className="text-sm text-blue-800">
              <span className="font-medium">Need help creating AWS credentials?</span>
              <p className="text-xs mt-1">Follow the AWS documentation to create an IAM user with programmatic access.</p>
            </div>
          </div>
          <Button
            variant="outline"
            ...
            onClick={() => window.open('https://docs.aws.amazon.com/IAM/latest/UserGuide/id_users_create.html', '_blank')}
          >
...
export default NewIAMCredentialPage 